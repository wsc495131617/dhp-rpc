...
public class CRCUtils {
	...
	public static long crc32(byte[] source) {
		CRC32 crc = new CRC32();
		crc.update(source);
		return crc.getValue();
	}
	
	public static long crc32(ByteBuffer source) {
		CRC32 crc = new CRC32();
		crc.update(source);
		return crc.getValue();
	}
	
	public final static char[] crc16_tb = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5,
	...
	public static short crc16(byte[] source) {
	...
	public static short crc16(ByteBuffer bytes){
		bytes.position(0);
		char crc;
		byte da;
		crc = 0x0;
